                        ...
                        <form action="" className='teacher-from'>
                            ...
                            <Row>
                                ...
                                <Col lg={12} className='form-group d-flex gap-3'>
                                    ...
                                    {/* <button type='button' className='btn-submit add-btn' onClick={() => addPeriod()} >  <AddCircleOutlineSharpIcon /> Add Period</button> */}
                                    {/* <Link to="" className='add-btn'>
                                        <AddCircleOutlineSharpIcon onClick={() => addPeriod()} />Add Period
                                    </Link> */}
                                </Col>
                            </Row>
                        </form>
