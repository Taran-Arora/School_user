            ...
            <Container >
                <div className="fee-table">
                    <div className='fee-table-custom'>
                        <h3 className='table-heading text-center'> DAV School Abohar  </h3>
                        <p className='table-des-heading'> Abohar - Hanumangarh Rd, South Evenue, Abohar,  Punjab 152116 </p>
                    </div>
                    ...
                    <table className="table">
                        <tbody className='f-tbody'>
                            <tr>
                                {/* <th className='col'> Student Name</th> */}
                                <td className='col for-hightlight for-d-f'> Date of Submition </td>
                                <td className='col  for-hightlight total-fees'> Amount   </td>
                            </tr>
